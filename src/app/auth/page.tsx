  ...
  return (
    <div className="relative bg-gradient-to-bl from-blue-100 via-transparent dark:from-blue-950 dark:via-transparent">
      <div className="mx-auto max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
                ...
                <div className="flex items-center gap-x-4">
                  <div className="shrink-0">
                    <Image
                      ...
                      src="/assets/authProfileImage.avif"
                      width={320}
                      height={320}
                      alt="Avatar"
                    />
        ...
        <div className="mt-6 flex items-center gap-x-1.5 py-3 text-sm text-gray-800 after:ms-6 after:flex-1 after:border-t after:border-gray-200 md:mt-12 dark:text-white dark:after:border-neutral-700">
        ...
        <div className="flex flex-wrap gap-x-6 sm:gap-x-12 lg:gap-x-24">
          <svg
            className="h-auto w-16 py-3 text-gray-500 md:w-20 lg:w-24 lg:py-5 dark:text-neutral-500"
