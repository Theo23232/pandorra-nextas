...
import { Images, Menu, Move, Zap } from "lucide-react"
import Image from "next/image"

import { AIImage } from "@/components/pandorra/image-generation/ai-image"
import { GenerationOption } from "@/components/pandorra/image-generation/generation-option"
    ...
    <Card className="w-full border-none bg-transparent">
      <CardContent>
        <div className="w-full pb-4 pt-8">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between py-2 text-base font-medium">
              <p>Prompt details</p>
