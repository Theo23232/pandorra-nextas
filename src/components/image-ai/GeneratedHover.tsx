...
export const DirectionAwareHover = ({
  ...
  return (
    <motion.div onMouseEnter={handleMouseEnter} ref={ref} className={cn('w-full h-full bg-transparent rounded-lg overflow-hidden group/card relative', className)}>
      <AnimatePresence mode='wait'>
        <motion.div className='relative h-full w-full' initial='initial' whileHover={direction} exit='exit'>
          ...
          >
            <Image alt='image' className={cn('h-full w-full object-cover scale-[1.15]', imageClassName)} width='600' height='800' src={imageUrl} />
          </motion.div>
          <motion.div
