...
import { EnrichedTweet, enrichTweet, TweetProps, TwitterComponents } from 'react-tweet';
...
export function TweetHeader({ tweet }: { tweet: EnrichedTweet }) {
  return (
          ...
          >
            ...
            {tweet.user.verified ||
              (tweet.user.is_blue_verified && (
                <Verified className="ml-1 inline size-4 text-primary" />
              ))}
          </a>
...
export function TweetBody({ tweet }: { tweet: EnrichedTweet }) {
  return (
...
export function TweetMedia({ tweet }: { tweet: EnrichedTweet }) {
  return (
