...
import {
    DayPicker, DayPickerRangeProps, DayPickerSingleProps, DayProps, Matcher, useDayPicker,
    useDayRender, useNavigation
    ...
    <DayPicker
      ...
      classNames={{
        ...
        day_selected: cx(
          ...
          "dark:aria-selected:bg-primary dark:aria-selected:text-white",
        ),
        day_disabled:
