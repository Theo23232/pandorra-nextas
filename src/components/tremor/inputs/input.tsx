...
const inputStyles = tv({
  base: [
    ...
    // file
    [
      "file:-my-2 file:-ml-2.5 file:cursor-pointer file:rounded-l-[5px] file:rounded-r-none file:border-0 file:px-4 file:py-3 file:outline-none focus:outline-none disabled:pointer-events-none file:disabled:pointer-events-none",
    ...
    return (
      <div className={cx("relative w-full", className)} tremor-id="tremor-raw">
        ...
        {isPassword && (
          <div
            className={cx(
              "absolute bottom-0 right-0 flex h-full items-center justify-center px-4",
            )}
          >
            <button
