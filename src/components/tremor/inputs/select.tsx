...
const selectTriggerStyles = [
  cx(
    // base
    "group/trigger flex h-10 w-full select-none items-center justify-between gap-2 truncate rounded-md border px-3 shadow-sm outline-none transition sm:text-sm",
    // border color
